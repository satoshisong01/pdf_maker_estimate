            ...
            <form className="input-menu" onSubmit={onSubmit}>
                <div className="inputdiv">
                    <h2 className="title-input">제목</h2>
                        <input type="text" className="inputbox inputbox-text" placeholder="추가할 타이틀을 적어주세요" onChange={onaddtitle}/>
                    <h2 className="title-input">가격</h2>
                        <input type="number" className="inputbox inputbox-num" placeholder="추가할 가격을 적어주세요" onChange={onaddprice}/>
                    <h2 className="title-input">내용</h2>
                        <input type="text" className="inputbox inputbox-con" placeholder="추가할 내용을 적어주세요" onChange={onaddcontent}/>
